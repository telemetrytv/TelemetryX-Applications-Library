export { telemetrySdkVersion } from '@telemetryx/root-sdk';
export { Accounts, Applications, Environment, Media, Store, Users } from '@telemetryx/root-sdk';
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function subscribe(...args: Parameters<Client['subscribe']>): Promise<import("@telemetryx/root-sdk").SubscriptionResult<void>>;
/**
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function unsubscribe(...args: Parameters<Client['unsubscribe']>): Promise<import("@telemetryx/root-sdk").SubscriptionResult<void>>;
/**
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function store(): import("@telemetryx/root-sdk").Store;
/**
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function applications(): import("@telemetryx/root-sdk").Applications;
/**
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function media(): import("@telemetryx/root-sdk").Media;
/**
 ...
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function accounts(): import("@telemetryx/root-sdk").Accounts;
/**
 * Provides access to the users API for retrieving TelemetryX user information.
 * @returns The Users API object
 * @throws {Error} If called before configure() or after destroy()
 */
export declare function users(): import("@telemetryx/root-sdk").Users;
