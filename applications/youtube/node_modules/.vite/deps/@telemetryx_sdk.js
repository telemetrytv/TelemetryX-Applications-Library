...
// node_modules/.pnpm/@telemetryx+sdk@1.0.0-alpha23/node_modules/@telemetryx/sdk/dist/index.js
var b;
(function(a) {
  a.assertEqual = (n) => n;
  function e(n) {
...
var et = (a) => JSON.stringify(a, null, 2).replace(/"([^"]+)":/g, "$1:");
var C = class qe extends Error {
  get errors() {
    return this.issues;
  }
  constructor(e) {
...
var ke = (a) => ({ status: "dirty", value: a });
var x = (a) => ({ status: "valid", value: a });
var Ee = (a) => a.status === "aborted";
var $e = (a) => a.status === "dirty";
var z = (a) => a.status === "valid";
var Q = (a) => typeof Promise < "u" && a instanceof Promise;
function we(a, e, t, s) {
  if (typeof e == "function" ? a !== e || true : !e.has(a)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
  return e.get(a);
}
function Ue(a, e, t, s, n) {
  if (typeof e == "function" ? a !== e || true : !e.has(a)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
  return e.set(a, t), t;
}
var p;
(function(a) {
...
var _ = class {
  ...
  safeParse(e, t) {
    ...
    const n = {
      common: {
        issues: [],
        async: (s = t == null ? void 0 : t.async) !== null && s !== void 0 ? s : false,
  ...
  "~validate"(e) {
    ...
    if (!this["~standard"].async)
      try {
        ...
        !((s = (t = i == null ? void 0 : i.message) === null || t === void 0 ? void 0 : t.toLowerCase()) === null || s === void 0) && s.includes("encountered") && (this["~standard"].async = true), n.common = {
          issues: [],
          async: true
        };
      }
  ...
  refine(e, t) {
    ...
    return this._refinement((n, i) => {
      ...
      return typeof Promise < "u" && r instanceof Promise ? r.then((d) => d ? true : (o(), false)) : r ? true : (o(), false);
    });
  }
  refinement(e, t) {
...
var at = /^c[^\s-]{8,}$/i;
var nt = /^[0-9a-z]+$/;
var it = /^[0-9A-HJKMNP-TV-Z]{26}$/i;
var rt = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i;
var ot = /^[a-z0-9_-]{21}$/i;
var dt = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/;
var ct = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/;
var ut = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i;
var lt = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
var Ae;
var ht = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/;
var pt = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/;
var mt = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/;
var ft = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/;
var yt = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/;
var gt = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/;
...
var N = class _N extends _ {
  ...
  datetime(e) {
    ...
    return typeof e == "string" ? this._addCheck({
      ...
      local: (s = e == null ? void 0 : e.local) !== null && s !== void 0 ? s : false,
...
N.create = (a) => {
  ...
  return new N({
    ...
    coerce: (e = a == null ? void 0 : a.coerce) !== null && e !== void 0 ? e : false,
    ...y(a)
  });
};
function xt(a, e) {
...
var P = (a) => a instanceof oe ? P(a.schema) : a instanceof S ? P(a.innerType()) : a instanceof de ? [a.value] : a instanceof pe ? a.options : a instanceof ce ? b.objectValues(a.enum) : a instanceof ue ? P(a._def.innerType) : a instanceof se ? [void 0] : a instanceof ae ? [null] : a instanceof O ? [void 0, ...P(a.unwrap())] : a instanceof M ? [null, ...P(a.unwrap())] : a instanceof Fe || a instanceof he ? P(a.unwrap()) : a instanceof le ? P(a._def.innerType) : [];
var Ce = class _Ce extends _ {
  _parse(e) {
  ...
  return a ? J.create().superRefine((s, n) => {
    ...
    if (o instanceof Promise)
      return o.then((d) => {
        var u, g;
        if (!d) {
          const w = De(e, s), I = (g = (u = w.fatal) !== null && u !== void 0 ? u : t) !== null && g !== void 0 ? g : true;
          n.addIssue({ code: "custom", ...w, fatal: I });
        }
      });
    if (!o) {
      const d = De(e, s), u = (r = (i = d.fatal) !== null && i !== void 0 ? i : t) !== null && r !== void 0 ? r : true;
...
var Qt = O.create;
var es = M.create;
var ts = S.createWithPreprocess;
var ss = me.create;
var as = () => Ge().optional();
var ns = () => Xe().optional();
var is = () => Qe().optional();
var rs = {
  string: (a) => N.create({ ...a, coerce: true }),
  number: (a) => R.create({ ...a, coerce: true }),
  boolean: (a) => te.create({
    ...a,
    coerce: true
  }),
  bigint: (a) => ee.create({ ...a, coerce: true }),
  date: (a) => q.create({ ...a, coerce: true })
};
var os = f;
...
//# sourceMappingURL=@telemetryx_sdk.js.map
