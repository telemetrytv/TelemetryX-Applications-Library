...
class $ {
   ...
   */
  get application() {
    return new w("application", this._client._applicationName, this._client);
  }
  /**
  ...
  get instance() {
    ...
    return new w("instance", e, this._client);
  }
  /**
  ...
  get device() {
    ...
    return new w("device", e, this._client);
  }
  /**
   ...
   */
  shared(e) {
    return new w("shared", `shared.${e}`, this._client);
  }
}
class w {
  constructor(e, t, s) {
