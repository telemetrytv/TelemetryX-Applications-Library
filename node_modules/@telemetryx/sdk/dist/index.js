...
const h = b.arrayToEnum([
  ...
  "not_multiple_of",
  "not_finite"
]), tt = (a) => JSON.stringify(a, null, 2).replace(/"([^"]+)":/g, "$1:");
let C = class Be extends Error {
  get errors() {
    return this.issues;
  }
  constructor(e) {
...
const f = Object.freeze({
  status: "aborted"
}), we = (a) => ({ status: "dirty", value: a }), Z = (a) => ({ status: "valid", value: a }), Ee = (a) => a.status === "aborted", $e = (a) => a.status === "dirty", D = (a) => a.status === "valid", G = (a) => typeof Promise < "u" && a instanceof Promise;
function ke(a, e, t, s) {
...
class _ {
  ...
  "~validate"(e) {
    ...
    return this._parseAsync({ data: e, path: [], parent: n }).then((i) => D(i) ? {
      value: i.value
    } : {
      issues: n.common.issues
    });
...
const nt = /^c[^\s-]{8,}$/i, it = /^[0-9a-z]+$/, rt = /^[0-9A-HJKMNP-TV-Z]{26}$/i, ot = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i, dt = /^[a-z0-9_-]{21}$/i, ct = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/, ut = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/, lt = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i, ht = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let Ae;
const pt = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/, mt = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\/(3[0-2]|[12]?[0-9])$/, ft = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$/, yt = /^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])\.){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\/(12[0-8]|1[01][0-9]|[1-9]?[0-9])$/, gt = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/, _t = /^([0-9a-zA-Z-_]{4})*(([0-9a-zA-Z-_]{2}(==)?)|([0-9a-zA-Z-_]{3}(=)?))?$/, Ke = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))", vt = new RegExp(`^${Ke}$`);
function He(a) {
  let e = "[0-5]\\d";
...
function xt(a, e) {
  return !!((e === "v4" || !e) && mt.test(a) || (e === "v6" || !e) && yt.test(a));
}
class N extends _ {
  _parse(e) {
    ...
    for (const n of this._def.checks)
      if (n.kind === "min")
        ...
        Ae || (Ae = new RegExp(ht, "u")), Ae.test(e.data) || (s = this._getOrReturnCtx(e, s), l(s, {
          validation: "emoji",
          code: c.invalid_string,
          message: n.message
        }), t.dirty());
        ...
        validation: "datetime",
        message: n.message
      }), t.dirty()) : n.kind === "date" ? vt.test(e.data) || (s = this._getOrReturnCtx(e, s), l(s, {
        code: c.invalid_string,
        validation: "date",
        message: n.message
      }), t.dirty()) : n.kind === "time" ? bt(n).test(e.data) || (s = this._getOrReturnCtx(e, s), l(s, {
        code: c.invalid_string,
        validation: "time",
        message: n.message
      }), t.dirty()) : n.kind === "duration" ? ut.test(e.data) || (s = this._getOrReturnCtx(e, s), l(s, {
        validation: "duration",
        code: c.invalid_string,
        message: n.message
      }), t.dirty()) : n.kind === "ip" ? wt(e.data, n.version) || (s = this._getOrReturnCtx(e, s), l(s, {
        validation: "ip",
        code: c.invalid_string,
        message: n.message
        ...
        code: c.invalid_string,
        message: n.message
      }), t.dirty()) : n.kind === "cidr" ? xt(e.data, n.version) || (s = this._getOrReturnCtx(e, s), l(s, {
        validation: "cidr",
        code: c.invalid_string,
        message: n.message
      }), t.dirty()) : n.kind === "base64" ? gt.test(e.data) || (s = this._getOrReturnCtx(e, s), l(s, {
        validation: "base64",
        code: c.invalid_string,
        message: n.message
      }), t.dirty()) : n.kind === "base64url" ? _t.test(e.data) || (s = this._getOrReturnCtx(e, s), l(s, {
  ...
  _parse(e) {
    ...
    for (const n of this._def.checks)
      n.kind === "int" ? b.isInteger(e.data) || (t = this._getOrReturnCtx(e, t), l(t, {
        ...
        exact: !1,
        message: n.message
      }), s.dirty()) : n.kind === "multipleOf" ? Zt(e.data, n.value) !== 0 && (t = this._getOrReturnCtx(e, t), l(t, {
...
let q = class ge extends _ {
  _parse(e) {
    ...
    if (n.minLength !== null && t.data.length < n.minLength.value && (l(t, {
      ...
      return Promise.all([...t.data].map((r, o) => n.type._parseAsync(new A(t, r, t.path, o)))).then((r) => x.mergeArray(s, r));
...
function U(a) {
  if (a instanceof w) {
    ...
    ...a._def,
    type: U(a.element)
  }) : a instanceof O ? O.create(U(a.unwrap())) : a instanceof R ? R.create(U(a.unwrap())) : a instanceof j ? j.create(a.items.map((e) => U(e))) : a;
}
class w extends _ {
  constructor() {
  ...
  _parse(e) {
    ...
    return s.common.async ? Promise.resolve().then(async () => {
      const d = [];
      for (const u of o) {
        const g = await u.key, k = await u.value;
        d.push({
          key: g,
          value: k,
      ...
      return d;
    }).then((d) => x.mergeObjectSync(t, d)) : x.mergeObjectSync(t, o);
  }
  get shape() {
...
const P = (a) => a instanceof re ? P(a.schema) : a instanceof S ? P(a.innerType()) : a instanceof oe ? [a.value] : a instanceof he ? a.options : a instanceof de ? b.objectValues(a.enum) : a instanceof ce ? P(a._def.innerType) : a instanceof te ? [void 0] : a instanceof se ? [null] : a instanceof O ? [void 0, ...P(a.unwrap())] : a instanceof R ? [null, ...P(a.unwrap())] : a instanceof Le || a instanceof le ? P(a.unwrap()) : a instanceof ue ? P(a._def.innerType) : [];
class Ce extends _ {
  _parse(e) {
  ...
  _parse(e) {
    ...
    if (this._def.returns instanceof W) {
      ...
      return Z(async function(...d) {
        ...
        }), k = await Reflect.apply(r, this, g);
        return await o._def.returns._def.type.parseAsync(k, i).catch((I) => {
          throw u.addIssue(n(k, I)), u;
        });
      });
    } else {
      const o = this;
      return Z(function(...d) {
        ...
        const g = Reflect.apply(r, this, u.data), k = o._def.returns.safeParse(g, i);
        if (!k.success)
          throw new C([n(g, k.error)]);
        return k.data;
      });
    }
  }
...
let he = class Fe extends _ {
  ...
  _parse(e) {
    ...
    if (ke(this, J) || Ue(this, J, new Set(this._def.values)), !ke(this, J).has(e.data)) {
      const t = this._getOrReturnCtx(e), s = this._def.values;
      return l(t, {
        received: t.data,
...
class de extends _ {
  ...
  _parse(e) {
    ...
    if (ke(this, Y) || Ue(this, Y, new Set(b.getValidEnumValues(this._def.values))), !ke(this, Y).has(e.data)) {
      const n = b.objectValues(t);
      return l(s, {
        received: s.data,
        code: c.invalid_enum_value,
  ...
  _parse(e) {
    ...
    if (i.addIssue = i.addIssue.bind(i), n.type === "preprocess") {
      ...
      if (s.common.async)
        return Promise.resolve(r).then(async (o) => {
          ...
          return d.status === "aborted" ? f : d.status === "dirty" || t.value === "dirty" ? we(d.value) : d;
        });
      {
        if (t.value === "aborted")
          return f;
        ...
        return o.status === "aborted" ? f : o.status === "dirty" || t.value === "dirty" ? we(o.value) : o;
      }
    }
    ...
    if (n.type === "transform")
      if (s.common.async === !1) {
        ...
        return this._def.schema._parseAsync({ data: s.data, path: s.path, parent: s }).then((r) => D(r) ? Promise.resolve(n.transform(r.value, i)).then((o) => ({ status: t.value, value: o })) : r);
    b.assertNever(n);
  }
}
  ...
  _parse(e) {
    ...
    if (s.common.async)
      return (async () => {
        ...
        return n.status === "aborted" ? f : n.status === "dirty" ? (t.dirty(), we(n.value)) : this._def.out._parseAsync({
          data: n.value,
          path: s.path,
          parent: s
        });
...
function Ge(a, e = {}, t) {
  return a ? H.create().superRefine((s, n) => {
    var i, r;
    const o = a(s);
    if (o instanceof Promise)
      return o.then((d) => {
        var u, g;
        if (!d) {
          const k = ze(e, s), I = (g = (u = k.fatal) !== null && u !== void 0 ? u : t) !== null && g !== void 0 ? g : !0;
          n.addIssue({ code: "custom", ...k, fatal: I });
        }
      });
    if (!o) {
      const d = ze(e, s), u = (r = (i = d.fatal) !== null && i !== void 0 ? i : t) !== null && r !== void 0 ? r : !0;
...
}) => Ge((t) => t instanceof a, e), Xe = N.create, Qe = X.create, St = Ne.create, Ot = Q.create, et = ee.create, At = z.create, jt = xe.create, It = te.create, Et = se.create, $t = H.create, Pt = L.create, Rt = $.create, Mt = Ze.create, Ft = q.create, Lt = w.create, Dt = w.strictCreate, zt = ae.create, qt = Ce.create, Bt = ne.create, Vt = j.create, Ut = ie.create, Kt = Te.create, Ht = B.create, Wt = Je.create, Jt = re.create, Yt = oe.create, Gt = he.create, Xt = de.create, Qt = W.create, qe = S.create, es = O.create, ts = R.create, ss = S.createWithPreprocess, as = pe.create, ns = () => Xe().optional(), is = () => Qe().optional(), rs = () => et().optional(), os = {
...
class fs {
   ...
   */
  get application() {
    return new me("application", this._client._applicationName, this._client);
  }
  /**
   ...
   */
  get instance() {
    const e = `${this._client._applicationName}.${this._client._applicationId}`;
    return new me("instance", e, this._client);
  }
  /**
   ...
   */
  get device() {
    const e = `${this._client._applicationName}.${this._client._applicationId}.device`;
    return new me("device", e, this._client);
  }
  /**
   ...
   */
  shared(e) {
    return new me("shared", `shared.${e}`, this._client);
  }
}
class me {
  constructor(e, t, s) {
...
class vs {
  ...
  request(e, t) {
    ...
    const o = new Promise((u, g) => {
      const k = new Error(`${e} message request with response name of ${s} timed out after ${V}`);
      setTimeout(() => {
        i = !0, this.off(s, r), g(k);
      }, V);
    }), d = new Promise((u) => {
      r = (g) => {
        i || u(g);
  ...
  async subscribe(e, t, s) {
    ...
    let g = !1, k;
    const I = new Promise((M, F) => {
      const Oe = new Error(`${e} subscribe request with subscription name of ${r} and response name of ${o} timed out after ${V}`);
      setTimeout(() => {
        g = !0, this.off(o, k), F(Oe);
      }, V);
    }), Se = new Promise((M) => {
      k = (F) => {
        g || M(F);
  ...
  async unsubscribe(e, t, s) {
    ...
    for await (const d of o) {
      ...
      let g = !1, k;
      const I = new Promise((M, F) => {
        const Oe = new Error(`${e} unsubscribe request with unsubscribe name of ${d} and response name of ${r} timed out after ${V}`);
        setTimeout(() => {
          g = !0, this.off(r, k), F(Oe);
        }, V);
      }), Se = new Promise((M) => {
        k = (F) => {
          g || M(F);
